 ...
 * @ClassName ComboxClass4
 * @Author grant (巩建春 e-mail : nnn987@126.com ;  QQ:406333743;   Tel:+86  15619212255)
 * @Date 2022/11/23 下午5:26
 * @Description TODO
 */
public class ComboxClass4<T1,T2,T3,T4>{
    private T1 _v1;
    private T2 _v2;
    private T3 _v3;
    private T4 _v4;
    ...
    public ComboxClass4(T1 _v1, T2 _v2, T3 _v3, T4 _v4) {
        this._v1 = _v1;
        this._v2 = _v2;
        this._v3 = _v3;
        this._v4 = _v4;
