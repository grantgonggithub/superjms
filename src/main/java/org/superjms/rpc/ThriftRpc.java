...
public class ThriftRpc {
    ...
    public interface AsyncIface {
        ...
        public void Send(java.lang.String my_args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
        ...
        public static class Send<I extends Iface> extends org.apache.thrift.ProcessFunction<I, Send_args> {
            ...
            public Send_result getResult(I iface, Send_args args) throws org.apache.thrift.TException {
                Send_result result = new Send_result();
                result.success = iface.Send(args.my_args);
                return result;
            }
        }
    ...
    public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
        ...
        public static class Send<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, Send_args, java.lang.String> {
            public Send() {
                super("Send");
            }
            ...
            public void start(I iface, Send_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
                iface.Send(args.my_args,resultHandler);
            }
        }
    ...
    public static class Send_args implements org.apache.thrift.TBase<Send_args, Send_args._Fields>, java.io.Serializable, Cloneable, Comparable<Send_args>   {
        ...
        private static final org.apache.thrift.protocol.TField MY_ARGS_FIELD_DESC = new org.apache.thrift.protocol.TField("my_args", org.apache.thrift.protocol.TType.STRING, (short)1);
        ...
        public @org.apache.thrift.annotation.Nullable java.lang.String my_args; // required

        /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
        public enum _Fields implements org.apache.thrift.TFieldIdEnum {
            MY_ARGS((short)1, "my_args");
        ...
        static {
            ...
            tmpMap.put(_Fields.MY_ARGS, new org.apache.thrift.meta_data.FieldMetaData("my_args", org.apache.thrift.TFieldRequirementType.DEFAULT,
        ...
        public Send_args(Send_args other) {
            if (other.isSetMy_args()) {
                this.my_args = other.my_args;
            }
        }
        ...
        @org.apache.thrift.annotation.Nullable
        public java.lang.String getMy_args() {
            return this.my_args;
        }

        public Send_args setMy_args(@org.apache.thrift.annotation.Nullable java.lang.String my_args) {
            this.my_args = my_args;
            return this;
        }

        public void unsetMy_args() {
            this.my_args = null;
        }

        /** Returns true if field my_args is set (has been assigned a value) and false otherwise */
        public boolean isSetMy_args() {
            return this.my_args != null;
        }

        public void setMy_argsIsSet(boolean value) {
            if (!value) {
                this.my_args = null;
            }
        }
            ...
            switch (field) {
                case MY_ARGS:
                    if (value == null) {
                        ...
                        setMy_args((java.lang.String)value);
                    }
                    break;
        ...
        public boolean equals(Send_args that) {
            ...
            boolean this_present_my_args = true && this.isSetMy_args();
            boolean that_present_my_args = true && that.isSetMy_args();
            if (this_present_my_args || that_present_my_args) {
                if (!(this_present_my_args && that_present_my_args))
                    return false;
                if (!this.my_args.equals(that.my_args))
                    return false;
            }
        ...
        public int hashCode() {
            ...
            hashCode = hashCode * 8191 + ((isSetMy_args()) ? 131071 : 524287);
            if (isSetMy_args())
                hashCode = hashCode * 8191 + my_args.hashCode();
        ...
        public int compareTo(Send_args other) {
            ...
            lastComparison = java.lang.Boolean.compare(isSetMy_args(), other.isSetMy_args());
            if (lastComparison != 0) {
                return lastComparison;
            }
            if (isSetMy_args()) {
                lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.my_args, other.my_args);
                if (lastComparison != 0) {
                    return lastComparison;
                }
            }
        ...
        public java.lang.String toString() {
            ...
            sb.append("my_args:");
            if (this.my_args == null) {
                sb.append("null");
            } else {
                sb.append(this.my_args);
            }
            first = false;
            sb.append(")");
            return sb.toString();
        ...
        private static class Send_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<Send_args> {
                    ...
                    switch (schemeField.id) {
                        case 1: // MY_ARGS
                            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                                struct.my_args = iprot.readString();
                                struct.setMy_argsIsSet(true);
                            } else {
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, Send_args struct) throws org.apache.thrift.TException {
                ...
                if (struct.my_args != null) {
                    oprot.writeFieldBegin(MY_ARGS_FIELD_DESC);
                    oprot.writeString(struct.my_args);
                    oprot.writeFieldEnd();
                }
